...
export default function Process() {
  const steps = [
    ...
    },
    {
      ...
      desc: "يزورك الفني المتخصص لمعاينة الموقع، وقياس جودة المياه ونسبة الأملاح الذائبة (PPM)، والاتفاق على المكان الأفضل لتركيب الفلتر أو نظام الرذاذ.",
    },
    {
      num: "٣",
      title: "التركيب والتشغيل والضمان الممتد",
      desc: "يقوم الفريق بنقل وتركيب النظام بدقة عالية وبشكل مخفي دون المساس بديكور مطبخك. نختبر ملوحة ونقاوة الماء الخارج، ونسلمك بطاقة الضمان الذهبي.",
    },
  ];
    ...
    <section id="process-section" className="py-20 md:py-24 bg-white" dir="rtl">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 flex flex-col items-center gap-2">
          <span className="section-subheading-tag">خطوات ميسرة وسريعة</span>
          <h2 className="section-heading-main">
            كيف نعمل في نثال لتأمين مياهك النقية؟
          </h2>
          <p className="lead-paragraph">
            نهدف لجعل تجربة حصولك على الخدمة مريحة وسلسة للغاية بدءاً من طلبك
            وحتى متابعة صيانة الفلاتر الدورية لسنوات قادمة.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center relative z-10">
            <div className="md:col-span-8 flex flex-col gap-3">
              <div className="inline-flex items-center gap-1.5 bg-blue-800/80 rounded-full px-3 py-1 border border-blue-700/50 text-sky-400 text-xs font-bold self-start">
                ...
                <span>سرعة قياسية وخدمة موثوقة</span>
              </div>

              <span className="text-xl sm:text-2xl font-extrabold ">
                التوصيل والتركيب خلال ٢٤ ساعة فقط في الرياض!
              </span>

              <span className="text-slate-100 text-xs sm:text-sm leading-relaxed font-bold">
                نعلم أهمية نقاوة واستمرار المياه لأسرتك ومطبخك أو منشأتك
                الموقرة. لذا نوفر أطقم طوارئ وفنيين تركيبات مجهزين للتحرك الفوري
                وإكمال العمل في نفس يوم طلب السعر أو باليوم الذي يليه مباشرة.
              </span>
            </div>
            ...
            <div className="md:col-span-4 flex flex-col sm:flex-row md:flex-col gap-4 self-center justify-center">
              <div className="bg-white/10 backdrop-blur-md p-4 rounded-2xl border border-white/10 flex items-center gap-3">
                ...
                <div className="flex flex-col text-right">
                  ...
                  <span className="text-[11px] text-slate-200 font-bold">
                    ضمان خلو من العيوب وسوء السباكة
                  </span>
                </div>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-md p-4 rounded-2xl border border-white/10 flex items-center gap-3">
                ...
                <div className="flex flex-col text-right">
                  <span className="text-xs font-bold text-white">
                    معاينة وفحص فني شامل
                  </span>
                  <span className="text-[11px] text-slate-200 font-bold">
                    فحص الأملاح والشبكة مجاناً
                  </span>
                </div>
              </div>
            </div>
