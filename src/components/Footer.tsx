      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="lg:col-span-4 flex flex-col gap-4">
            <div className="flex items-center gap-3 select-none">
              ...
              <span className="text-lg font-extrabold text-white">
                مؤسسة نثـال لتنقية المياه
              </span>
            </div>

            <p className="text-xs sm:text-sm text-slate-300 leading-relaxed font-semibold">
              شريكك الوطني لحلول محطات التحلية المركزية، والفلاتر المنزلية،
              والبرادات، وأنظمة الرذاذ والتبريد الخارجي في الرياض، مع تنفيذ سريع
              وصيانة موثوقة.
            </p>
        ...
        <div className="border-t border-slate-800 pt-8 flex flex-col md:flex-row items-center justify-between text-center text-xs text-slate-300 gap-4">
          ...
          <div className="flex items-center gap-4 text-[11px] font-bold">
            <span className="text-slate-200 font-extrabold bg-blue-950 px-2 py-0.5 rounded text-[10px]">
              Tamara
            </span>
            <span className="text-slate-200 font-extrabold bg-cyan-950 px-2 py-0.5 rounded text-[10px]">
              Tabby
            </span>
