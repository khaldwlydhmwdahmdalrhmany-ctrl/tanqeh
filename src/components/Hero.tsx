        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-10 xl:gap-14 items-center">
          ...
          <div className="lg:col-span-6 flex flex-col items-start gap-6 text-right">
            ...
            >
              ...
              <span>مؤسسة سعودية معتمدة ومرخصة سِجِل تجاري رقم: 1010620807</span>
            </motion.div>
            ...
            <AnimatePresence mode="wait">
              ...
              >
                {HERO_SLIDES[activeIdx].desc} نوفر لك أحدث محطات تحلية المياه المنزلية المتكاملة مع الفحص المجاني للملوحة للمطبخ، البرادة، وجدولة الصيانات السنوية في الرياض.
              </motion.p>
            </AnimatePresence>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 w-full border-t border-slate-100 pt-5">
              <div className="flex items-center gap-2.5 bg-white p-3 rounded-xl border border-slate-100 hover:border-blue-100 transition-colors shadow-[0_2px_8px_rgba(0,0,0,0.01)]">
                ...
                <div className="flex flex-col text-right">
                  <span className="text-xs font-extrabold text-slate-800">ضمان ذهبي ممتد</span>
                  <span className="text-[10px] text-slate-600 font-semibold">يشمل جميع القطع الكهربائية والهيكل</span>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2.5 bg-white p-3 rounded-xl border border-slate-100 hover:border-blue-100 transition-colors shadow-[0_2px_8px_rgba(0,0,0,0.01)]">
                ...
                <div className="flex flex-col text-right">
                  <span className="text-xs font-extrabold text-slate-800">تركيب وتوصيل سريع</span>
                  <span className="text-[10px] text-slate-600 font-semibold">فريق مهندسين معالجة جاهز بالرياض خلال 24 ساعة</span>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2.5 bg-white p-3 rounded-xl border border-slate-100 hover:border-blue-100 transition-colors shadow-[0_2px_8px_rgba(0,0,0,0.01)]">
                ...
                <div className="flex flex-col text-right">
                  <span className="text-xs font-extrabold text-slate-800">فحص وضبط ملوحة مجاني</span>
                  <span className="text-[10px] text-slate-600 font-semibold">نوازن الملوحة حسب رغبتك (من 100 لـ 150)</span>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2.5 bg-white p-3 rounded-xl border border-slate-100 hover:border-blue-100 transition-colors shadow-[0_2px_8px_rgba(0,0,0,0.01)]">
                ...
                <div className="flex flex-col text-right">
                  <span className="text-xs font-extrabold text-slate-800">صيانة دورية ذكية</span>
                  <span className="text-[10px] text-slate-600 font-semibold">نذكرك بمواعيد تبديل الفلاتر أوتوماتيكياً</span>
                </div>
              </div>
            </div>
            ...
            <div className="w-full border-t border-slate-100 pt-5 space-y-2.5">
              ...
              <div className="flex flex-wrap items-center gap-3.5">
                <div className="bg-[#FFF9E6]/80 hover:bg-[#FFF2CC] rounded-xl px-4 py-2 border border-[#FFE299]/50 flex items-center justify-center h-10 transition-all duration-300 shadow-xs">
                  <img src={tamaraLogo} alt="تمارا لتقسيط مبيعات المياه" className="h-16 w-auto object-contain" referrerPolicy="no-referrer" />
                </div>
                <div className="bg-[#E5FFF3]/80 hover:bg-[#CCFFE6] rounded-xl px-4 py-2 border border-[#99FFCC]/50 flex items-center justify-center h-10 transition-all duration-300 shadow-xs">
                  <img src={tabbyLogo} alt="تابي لتقسيط فلاتر المياه" className="h-18 w-auto object-contain" referrerPolicy="no-referrer" />
                </div>
          ...
          >
            ...
            <div className="absolute top-5 right-5 z-20 flex gap-2">
              {HERO_SLIDES.map((slide, idx) => (
                ...
                >
                  {idx === 0 ? '🏆 الأكثر مبيعاً الرياض' : '🔥 عروض التقسيط المزدوج'}
                </button>
              ))}
            </div>
            ...
            <button
              onClick={() => setActiveIdx((prev) => (prev - 1 + HERO_SLIDES.length) % HERO_SLIDES.length)}
            ...
            <div className="absolute bottom-5 right-5 left-5 z-20 flex flex-col sm:flex-row justify-between items-stretch sm:items-center gap-3 bg-white/94 backdrop-blur-md p-4 rounded-2xl shadow-xl border border-white/50 text-right">
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col">
                  <span className="text-[11px] font-black text-[#0c2340]">ملوحة مياه صحية وموزونة</span>
                  <span className="text-[10px] font-bold text-slate-700">نطاق مثالي آمن: 100 - 150 TDS لشرب مثالي وعذب</span>
                </div>
              </div>
