    ...
    <section id="products-section" className="py-20 md:py-24 bg-white" dir="rtl">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-12 flex flex-col items-center gap-2">
          ...
          <p className="lead-paragraph">اختر جهازك المفضل واطلع على المزايا التفصيلية. نقوم بالتوصيل والتركيب الفوري في الرياض بضمانات حسب المنتج.</p>
        ...
        <div className="flex flex-wrap justify-center items-center gap-2 mb-12">
          {categories.map((cat) => (
            <button
              key={cat.id}
              onClick={() => setSelectedCategory(cat.id as 'filter' | 'cooler' | 'mist' | 'maintenance' | 'all')}
          ...
          {filteredProducts.map((product) => (
            <div key={product.id} className="group flex flex-col bg-white rounded-3xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border border-slate-100">
              <div className="relative overflow-hidden aspect-[4/3] bg-slate-100">
                {product.isPopular && (
                  <div className="absolute top-4 right-4 z-10 bg-red-500 text-white px-3 py-1 font-bold rounded-lg text-[10px] uppercase tracking-wider shadow-sm">
                    الأكثر طلباً ⭐
                  </div>
                )}
              ...
              <div className="p-6 flex flex-col flex-grow text-right">
                ...
                <div className="flex items-center gap-2 mt-auto pt-4 border-t border-slate-50">
                  ...
                  <button onClick={() => setSelectedProductDetails(product)} className="btn-secondary h-10 w-10 flex items-center justify-center rounded-xl p-0 shrink-0" title="المزيد من المواصفات الفنية">
            ...
            <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
              ...
              <div className="inline-block align-bottom bg-white rounded-3xl text-right overflow-hidden shadow-2xl transform transition-all sm:my-8 sm:align-middle sm:max-w-2xl sm:w-full border border-slate-100">
                ...
                <div className="p-6 sm:p-8">
                  ...
                  <h5 className="text-sm font-extrabold text-[#0a1e36] mb-3">مزايا هذا الجهاز:</h5>
