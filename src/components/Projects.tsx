...
import projectCommercialRoImg3 from "@/assets/projects/images/project-commercial-ro3.jpg";
import projectCommercialRoImg8 from "@/assets/projects/images/project-commercial-ro8.jpg";
import projectCommercialRoImg9 from "@/assets/projects/images/project-commercial-ro9.jpg";
import projectHomeFilterImg2 from "@/assets/projects/images/project-commercial-ro2.jpg";
import projectHomeFilterImg4 from "@/assets/projects/images/project-commercial-ro4.jpg";
import projectHomeFilterImg5 from "@/assets/projects/images/project-commercial-ro5.jpg";
import projectHomeFilterImg6 from "@/assets/projects/images/project-commercial-ro6.jpg";
import projectHomeFilterImg10 from "@/assets/projects/images/project-commercial-ro10.jpg";
import projectGardenMistImg from "@/assets/projects/images/project-commercial-ro.jpg";
import projectGardenMistImg7 from "@/assets/projects/images/project-commercial-ro7.jpg";
...
const FIELD_PROJECTS: FieldProject[] = [
  {
    id: "PRJ-NV01",
    title:
      "تركيب فلتر غولدن برو (7 مراحل المطور) وتوصيله ببرادة سول أكوا السوداء",
    category: "filter",
    ...
    notes:
      "تم تثبيت الفلتر الفيتنامي ذو الـ 7 مراحل أسفل المجلى مع خزان ضغط فولاذي 40 لتر بدقة عالية، وتوصيله بموزع وبرادة مياه سول أكوا سوداء أنيقة لتوفير دائم للشرب دون قوارير.",
    image: projectHomeFilterImg2,
  ...
  },
  {
    ...
    notes:
      "تركيب البرادة الفضية الفاخرة للشركة وتغذيتها مباشرة عبر الفلتر المدمج 5 مراحل لتجنب عناء تبديل قوارير المياه، وتوفير ماء مبرد وساخن باستقرار.",
    image: projectCommercialRoImg3,
  ...
  {
    id: "PRJ-NV03",
    title: "تأسيس نظام تحلية MAAS المركزي وتوصيل صانعة الثلج Brema والإسبريسو",
    category: "central",
    ...
    purityResult: "مستوى ملوحة 55 PPM (المثالي لنكهة وجودة الإسبريسو)",
    notes:
      "تركيب الفلاتر الثلاثية ومضخة تايوانية فائقة السرعة مع أنابيب خضراء لتغذية جهاز الثلج الإيطالي Brema وآلة الإسبريسو لحمايتهما من الكلس والتكلسات.",
  ...
  },
  {
    ...
    date: "أبريل 2026",
    systemModel: "جهاز Reeboon المطوّر مع عداد قياس الضغط",
    capacity: "إنتاج 280 لتر مياه نقية يومياً مع تدفق مستقر",
    purityResult: "ملوحة متوازنة صحية 72 PPM",
    notes:
      "تركيب الوحدة المدمجة 6 مراحل تحت المجلى وتأمين المياه العذبة لصنبور الكروم الفريش لضمان مياه نقية وصحية للطهي والشراب اليومي للأطفال.",
    image: projectHomeFilterImg4,
  ...
  },
  {
    ...
    notes:
      "تأسيس صمامات ومحابس زرقاء مرنة لإيصال المياه لغلاية Bunn الاحترافية لضمان ثبات جودة بخار الماء ومنع تراكم الأملاح والصدأ بالأداة بشكل تام.",
    image: projectHomeFilterImg5,
  ...
  },
  {
    ...
    notes:
      "تظهر خدمات الصيانة الدورية من نثال؛ حيث يلتزم الفني بتبديل دقيق وتطهير الأنابيب مع وضع الملصق المعتمد وبه الهاتف الموحد للمؤسسة 0553033199.",
    image: projectHomeFilterImg6,
  ...
  },
  {
    ...
    notes:
      "تجهيز خزان الخلط الدائري مع تركيب شبكة الأنابيب النايلون وفوهات السيراميك المضادة للتنقيط لتلطيف وهندسة هواء رطب ومريح في الصيف الحار.",
    image: projectGardenMistImg7,
  ...
  },
  {
    id: "PRJ-NV08",
    title:
      "تركيب نظام فلترة وتمرير المياه لأجهزة الإسبريسو والمشروبات الساخنة والباردة",
    category: "filter",
    categoryLabel: "فلاتر وأجهزة تحلية سكنية",
    location: "الرياض، حي العليا - كافيه البن الفاخر",
    customerName: "مقهى دوز للنكهة",
    date: "أبريل 2026",
    ...
    purityResult: "معدل ملوحة 60 PPM مطابق لمعايير القهوة SCA",
    notes:
      "ربط الفلتر مباشرة بمصدر مياه البلدية وفلترة الماء بـ 3 مراحل إضافية مدمجة لإزالة الكلور الكيميائي تماماً ومنح الإسبريسو طعمه الفريد.",
    image: projectCommercialRoImg8,
  ...
  },
  {
    ...
    notes:
      "قامت مؤسسة نثال في هذا المشروع بتجهيز كامل للمحطة لقصور سكنية كبيرة لضمان تدفق عذب وصحي لجميع شبكات الاستحمام والغسيل والمطابخ بأنابيب نانو آمنة.",
    image: projectCommercialRoImg9,
  ...
  },
  {
    id: "PRJ-NV10",
    title:
      "تركيب محطة فلترة جامبو ثلاثية الخزان العلوي لحماية المبنى والغسالات من الرمل والشوائب",
    category: "central",
    categoryLabel: "محطات مركزية وصناعية",
    location: "الرياض، حي الملقا - عمارة سكنية عائلية",
    customerName: "مبنى الفلل الفاخرة للعهد",
    date: "فبراير 2026",
    ...
    notes:
      "تم تجميع وتنصيب فلاتر جامبو على السطح بعد عداد المياه لحماية عيون الغسالات وخلاطات المطبخ والحمامات بالمبنى لزيادة عمرها وتفادي بقع الملابس البيضاء.",
    image: projectHomeFilterImg10,
  ...
  },
  {
    id: "PRJ-NV11",
    title:
      "توسيع وتأسيس نظام الفلترة الثلاثية المتقدم للمباني والمصانع التجارية الكبيرة",
    category: "central",
    categoryLabel: "محطات مركزية وصناعية",
    ...
    capacity: "مضخات وقدرة تغذية على مدار 24 ساعة متواصلة",
    purityResult: "مياه عالية النقاوة للحد من آثار الصدأ",
    notes:
      "تركيب النظام الثلاثي لضمان خروج ماء ناعم وخالي من الكالسيوم والمعادن الثقيلة لحماية الأفران البخارية والآلات الصناعية وغسالات الاستعمال الرياضي الكثيف.",
    image: projectCommercialRoImg,
  ...
  const handleLoadedMetadata = () => {
    if (videoRef.current) {
      ...
      if (width && height) {
        ...
        console.log(
          `Auto detected ratio for ${project.id}: ${width}x${height} = ${ratio}`,
        );
      }
    }
  };
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 p-4 flex flex-col justify-between text-white/70 font-mono text-[9px] pointer-events-none select-none z-20">
        ...
        <div
          className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-white/15 transition-all duration-300 pointer-events-none text-xl ${
      ...
      <div
        className={`absolute bottom-0 inset-x-0 p-3.5 flex flex-col gap-2 z-30 transition-opacity duration-300 ${
...
export default function Projects() {
  const [activeTab, setActiveTab] = useState<
    "all" | "filter" | "central" | "mist" | "cooler"
  >("all");
  ...
  return (
    <section
      id="projects-section"
      className="py-20 md:py-24 bg-gradient-to-b from-white via-[#fcfdfe] to-[#f4f8fc]"
      dir="rtl"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 flex flex-col items-center gap-2">
          ...
          <h2 className="section-heading-main">
            معرض المشاريع والتوثيق الحي بالرياض
          </h2>
          <p className="lead-paragraph">
            لا داعي للتخمينات! شاهد بالفيديو الفعلي أدناه خدماتنا الميدانية
            والتأسيسات الحقيقية التي نفذها مهندسو نثال في منازل ومؤسسات الرياض
            بالصوت وجودة الـ HD.
          </p>
            ...
            <div className="w-full lg:w-2/5 flex flex-col justify-between text-right">
              <div className="space-y-6">
                <div className="inline-flex items-center gap-1.5 bg-blue-500/10 border border-blue-500/30 text-blue-400 px-3.5 py-1.5 rounded-lg text-xs font-extrabold">
                  ...
                  <span>فلترة حية 100%، مياه متوازنة وصفر عكارة</span>
                </div>

                <div className="space-y-2">
                  <span className="text-xs font-bold text-sky-400 font-mono tracking-widest uppercase block">
                    المعاينة النشطة بالبث الحي
                  </span>
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    ...
                    <span className="text-sm font-semibold text-slate-300">
                      {REEL_PROJECTS[activeReelIdx].location}
                    </span>
                  </div>
                </div>
                ...
                <div className="bg-[#101f35] border border-slate-800 p-5 rounded-2xl relative">
                  <span className="text-xs font-bold text-slate-300 block mb-1">
                    تفاصيل التركيب وعمل الوحدة المنجزة:
                  </span>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-[#0f2441] border border-blue-900/40 p-3.5 rounded-xl">
                    ...
                    <span className="text-sm font-extrabold text-white mt-1 block">
                      {REEL_PROJECTS[activeReelIdx].systemModel}
                    </span>
                  </div>

                  <div className="bg-[#071d36] border border-blue-900/40 p-3.5 rounded-xl">
                    <span className="text-[10px] text-emerald-400 font-bold block">
                      تحليل النقاء والأملاح:
                    </span>
                    <span className="text-sm font-extrabold text-[#00e676] mt-1 block">
                      {REEL_PROJECTS[activeReelIdx].purityResult}
                    </span>
                  </div>
                </div>
              </div>
            ...
            <div className="w-full lg:w-3/5 flex flex-col justify-between">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 justify-items-center items-end py-4 lg:py-0">
                {REEL_PROJECTS.map((project, idx) => (
                  ...
                  >
                    ...
                    >
                      {idx === 0
                        ? "١. فلتر غولدن برو بمطبخ"
                        : idx === 1
                          ? "٢. تغذية برادة مياه"
                          : "٣. محطة كافيه ومكينة ثلج"}
                    </button>
                  </div>
                ))}
              </div>
              ...
              <div className="flex items-center justify-between text-xs text-slate-400 mt-6 pt-4 border-t border-slate-900 leading-none">
                <span className="flex items-center gap-1.5 text-sky-400 font-semibold animate-pulse">
                  ...
                  <span>
                    اضغط على أي فيديو حي لتشغيله/إيقافه وتفعيل الصوت أو تكبير
                    الشاشة
                  </span>
                </span>
                ...
                <div className="p-5 flex-grow flex flex-col justify-between gap-4">
                  ...
                  <div className="flex flex-wrap gap-1.5 pt-1">
                    {project.tags.map((tag, i) => (
                      <span
                        key={i}
                        className="text-[10px] font-extrabold bg-slate-100 border border-slate-200 text-slate-800 px-2.5 py-0.5 rounded"
                      >
                        #{tag}
                      </span>
                    ))}
                  ...
                  <div className="pt-4 border-t border-slate-100 flex items-center justify-between text-[11px] font-bold text-slate-600">
                    <div className="flex flex-col text-right">
                      <span className="text-[10px] text-slate-650 block font-bold">
                        نقاء الفحص:
                      </span>
                      <span className="text-slate-800 font-extrabold mt-0.5">
                        {project.purityResult}
                      </span>
                    </div>
